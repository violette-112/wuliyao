...
export default function ExampleGallery() {
  // 读取 Vite base（本地开发是 '/'，GitHub Pages 部署是 '/wuliyao/'），确保静态资源路径正确，防 Pages 子路径 404
  ...
  const examples = [
    {
      ...
      image: `${BASE}/examples/simple-tshirt.jpg`,
    },
    {
      template: "短袖T恤",
      params: "16色 · 8px笔刷",
      description: "标准短袖设计，含领口和腰带",
      image: `${BASE}/examples/short-sleeve-tshirt.jpg`,
    },
    {
      template: "坦克背心",
      params: "8色 · 8px笔刷",
      description: "短款背心，大面积锁定",
      image: `${BASE}/examples/tank-top.jpg`,
    },
    {
      template: "长袖T恤",
      params: "24色 · 8px笔刷",
      description: "长袖设计，两侧袖子锁定",
      image: `${BASE}/examples/long-sleeve-tshirt.jpg`,
    },
  ];
  ...
  return (
    <section className="w-full max-w-7xl mx-auto px-4 py-8 sm:py-12">
      <h2
        className="text-sm font-bold text-gray-700 text-center mb-6 sm:mb-8"
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 sm:gap-4">
        {examples.map((ex, idx) => (
          <div
            key={idx}
            className="bg-white rounded-2xl shadow-md p-3 sm:p-4 border border-gray-100 hover:shadow-lg transition-shadow cursor-pointer"
          >
